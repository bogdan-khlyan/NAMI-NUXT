...
<script>
import FormLabel from "@/components/cart/order/orderForm/FormLabel";
...
import Ymap from "@/components/cart/order/orderForm/map/Ymap";

export default {
  name: 'order-chapter3',
  components: { ChapterLabel, InputExpand, Ymap, FormLabel },
  model: {
    prop: 'data',
    event: 'input'
  },
